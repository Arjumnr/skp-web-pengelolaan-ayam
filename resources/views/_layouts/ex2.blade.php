...
<body>
                                        ...
                                        <table id="orders" class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>$230</td>
                                                    <td>
                                                        <span class="badge bg-secondary-bright text-secondary">On
                                                            pre-order (not paid)</span>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$250</td>
                                                    <td>
                                                        <span class="badge bg-danger-bright text-danger">Payment
                                                            error</span>
                                                    </td>
                                                    <td>2018/08/28 21:24:36</td>
                                                    <td class="text-right">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$280</td>
                                                    <td>
                                                        <span class="badge bg-warning-bright text-warning">Preparing
                                                            the order</span>
                                                    </td>
                                                    <td>2018/08/28 21:24:36</td>
                                                    <td class="text-right">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge bg-secondary-bright text-secondary">Shipped</span>
                                                    </td>
                                                    <td>2018/08/28 21:24:36</td>
                                                    <td class="text-right">
                                                        <div class="dropdown">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>$300</td>
                                                    <td>
                                                        <span class="badge bg-success-bright text-success">Remote
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge bg-success-bright text-success">Delivered</span>
                                                    </td>
                                                    <td>2018/08/28 21:24:36</td>
                                                    <td class="text-right">
                                                        <div class="dropdown">
    ...
    <script src="../../assets/js/examples/pages/orders.js"></script>
