...
<head>
    ...
    <!-- Daterangepicker -->
    <link rel="stylesheet" href="{{ asset('templates/vendors/datepicker/daterangepicker.css') }}" type="text/css">

    <!-- DataTable -->
    <link rel="stylesheet" href="{{ asset('templates/vendors/dataTable/datatables.min.css') }}" type="text/css">
