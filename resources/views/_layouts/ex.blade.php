                                            ...
                                            <div class="list-group list-group-flush">
                                                <a href="#" class="list-group-item d-flex align-items-center">
                                                    <div class="pr-3">
                                                        <div class="avatar avatar-state-danger">
                                                            <span
                                                                class="avatar-title bg-success rounded-circle">F</span>
                                                        </div>
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-1">Francisco Ubsdale</h6>
                                                    ...
                                                    <div class="text-right ml-auto d-flex flex-column">
                                                        <span
                                                            class="badge badge-success badge-pill ml-auto mb-2">1</span>
                                                        <span class="small text-muted">2:32 PM</span>
                                                    </div>
                                                </a>
                                                <a href="#" class="list-group-item d-flex align-items-center">
                                                    ...
                                                    <div class="text-right ml-auto d-flex flex-column">
                                                        <span
                                                            class="badge badge-success badge-pill ml-auto mb-2">3</span>
                                                        <span class="small text-muted">08:27 PM</span>
                                                    </div>
                                                </a>
                                                <a href="#"
                                                ...
                                                <a href="#" class="list-group-item d-flex align-items-center">
                                                    <div class="pr-3">
                                                        <span class="avatar avatar-state-secondary">
                                                            <span
                                                                class="avatar-title bg-warning rounded-circle">D</span>
                                                        </span>
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-1">Dudley Laborde</h6>
                                            ...
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item d-flex align-items-center">
                                                    <div class="pr-3">
                                                        <div class="avatar avatar-state-danger">
                                                            <span
                                                                class="avatar-title bg-secondary rounded-circle">A</span>
                                                        </div>
                                                    </div>
                                                    <div>
                                                ...
                                                <li class="list-group-item d-flex align-items-center">
                                                    <div class="pr-3">
                                                        <div class="avatar avatar-state-secondary">
                                                            <span
                                                                class="avatar-title bg-success rounded-circle">A</span>
                                                        </div>
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-1">Alene Ranyelld</h6>
                                    ...
                                    <div class="form-group">
                                        <div class="chat-footer-buttons">
                                            <button class="btn btn-outline-light mr-2" type="button"
                                                title="Emoji" data-toggle="tooltip">
                                        ...
                                        <div class="chat-footer-buttons">
                                            <button class="btn btn-outline-light" type="button"
                                                title="Attach files" data-toggle="tooltip">
                                                <i class="ti-link"></i>
                                            </button>
