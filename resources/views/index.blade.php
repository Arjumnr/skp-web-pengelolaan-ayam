                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="mb-0"><a class="link-1" href="#">See visits</a> that
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="mb-0"><a class="link-1" href="#">See referring</a>
                                domains that sent most visits
                                last month.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-scroll" style="height: 430px">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex px-0 py-4">
                                <a href="#" class="flex-shrink-0">
                                    <figure class="avatar mr-3">
                                        <img src="templates/assets/media/image/user/man_avatar1.jpg"
                            ...
                            <li class="list-group-item d-flex px-0 py-4">
                                <a href="#" class="flex-shrink-0">
                                    <figure class="avatar mr-3">
                                        <img src="templates/assets/media/image/user/man_avatar2.jpg"
                                            class="rounded-circle" alt="image">
                                    </figure>
                                </a>
                                <div class="flex-grow-1">
                            ...
                            <li class="list-group-item d-flex px-0 py-4">
                                <a href="#" class="flex-shrink-0">
                                    <figure class="avatar mr-3">
                                        <img src="templates/assets/media/image/user/man_avatar3.jpg"
                                            class="rounded-circle" alt="image">
                                    </figure>
                                </a>
                                <div class="flex-grow-1">
                            ...
                            <li class="list-group-item d-flex px-0 py-4">
                                <a href="#" class="flex-shrink-0">
                                    <figure class="avatar mr-3">
                                        <img src="templates/assets/media/image/user/man_avatar4.jpg"
                                            class="rounded-circle" alt="image">
                                    </figure>
                                </a>
                                <div class="flex-grow-1">
                ...
                <table id="recent-orders" class="table">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <a href="product-detail.html" class="d-flex align-items-center">
                                    <img width="40" src="templates/assets/media/image/products/product1.png"
                            ...
                            <td>$230</td>
                            <td>
                                <span class="badge bg-secondary-bright text-secondary">On pre-order
                                    (not paid)</span>
                            </td>
                            <td>2020/02/28</td>
                            <td class="text-right">
                        ...
                        <tr>
                            <td>
                                <a href="product-detail.html" class="d-flex align-items-center">
                                    <img width="40" src="templates/assets/media/image/products/product2.png"
                        ...
                        <tr>
                            <td>
                                <a href="product-detail.html" class="d-flex align-items-center">
                                    <img width="40" src="templates/assets/media/image/products/product3.png"
                        ...
                        <tr>
                            <td>
                                <a href="product-detail.html" class="d-flex align-items-center">
                                    <img width="40" src="templates/assets/media/image/products/product4.png"
                        ...
                        <tr>
                            <td>
                                <a href="product-detail.html" class="d-flex align-items-center">
                                    <img width="40" src="templates/assets/media/image/products/product5.png"
                        ...
                        <tr>
                            <td>
                                <a href="product-detail.html" class="d-flex align-items-center">
                                    <img width="40" src="templates/assets/media/image/products/product6.png"
                        ...
                        <tr>
                            <td>
                                <a href="product-detail.html" class="d-flex align-items-center">
                                    <img width="40" src="templates/assets/media/image/products/product7.png"
                        ...
                        <tr>
                            <td>
                                <a href="product-detail.html" class="d-flex align-items-center">
                                    <img width="40" src="templates/assets/media/image/products/product8.png"
                        ...
                        <tr>
                            <td>
                                <a href="product-detail.html" class="d-flex align-items-center">
                                    <img width="40" src="templates/assets/media/image/products/product9.png"
                        ...
                        <tr>
                            <td>
                                <a href="product-detail.html" class="d-flex align-items-center">
                                    <img width="40" src="templates/assets/media/image/products/product10.png"
